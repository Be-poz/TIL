...
결과로 0.232sec이 나왔다. (m1 이슈가 있다고 한다. 정상적인 쿼리다!)  
...
**알고보니 m1 속도 이슈가 있었다. 윈도우나 인텔 맥으로 돌릴 시에는 속도가 확연히 빠르다고 한다! 0.2s 이니 넘어가겠다!**  
...
Member의 age 컬럼과 Covid에 programmer_id와 name이 인덱스 걸려있는 상태로 돌려보았고,  
0.336sec 의 결과를 얻을 수 있었다. m1이슈가 아니라면 이 또한 0.1sec 미만일 것이라 추측하고(적절한 인덱스를 모두 건 결과이기에) 해결되었다고 판단하겠다!  
